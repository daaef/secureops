...
const Footer = () => {
    ...
    return (
        <footer className='bg-black text-gray-200 p-5 py-10 md:py-20'>
            ...
            <div
                className='mx-auto container flex  gap-4 flex-col sm:flex-row items-center justify-between mt-20 text-gray-400 text-sm'>
                <h2>© SecureOps Solutions LLC</h2>
                <div className='flex gap-8'>
                    <Link>Privacy Policy</Link>|<Link>Terms and Services</Link>
                </div>
            </div>
        </footer>
    );
