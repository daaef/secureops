...
export const socialMediaProfiles = [
  ...
  { title: 'Twitter/X', href: 'https://secureops-solutions.tech/contact', icon: GitHubIcon },
  { title: 'linkedIn', href: 'https://dribbble.com', icon: DribbbleIcon },
]
      ...
      {socialMediaProfiles.map((socialMediaProfile) => (
        <li key={socialMediaProfile.title}>
          <Link
            ...
            className={clsx(
              'transition',
              invert ? 'hover:text-primary-200' : 'hover:text-primary-700',
            )}
          >
